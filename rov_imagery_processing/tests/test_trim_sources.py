...
from rov_imagery_processing import videoclip  # noqa: E402
...
def test_overlay_inputs_are_bounded_to_the_segment():
    ...
    src = (Path(__file__).resolve().parents[1] / "rov_imagery_processing"
...
def test_discovery_does_not_treat_trims_as_chapters():
    from rov_imagery_processing import discovery
...
def test_the_scan_describes_trims_without_claiming_a_timecode(tmp_path):
    ...
    """
    from rov_imagery_processing.gui.videopage import VideoPage
