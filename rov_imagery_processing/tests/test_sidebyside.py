...
from rov_imagery_processing import ffmpeg_tools as ff  # noqa: E402
from rov_imagery_processing import sidebyside as sbs  # noqa: E402
...
def test_a_stray_recording_from_another_day_does_not_move_the_window(monkeypatch):
    ...
    from rov_imagery_processing import mcap_extract
