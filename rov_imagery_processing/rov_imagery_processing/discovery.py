...
The going-forward convention is::
    ...
    <flight>/
        logs/          *.mcap  (or logs/mcap/*.mcap, where downloads land)
        photos/
        videos/
...
#: logs/mcap first: it is where ROV Flight Operations downloads recordings to.
_MCAP_DIRS = ("logs/mcap", "logs", "log", "", "mcap", "telemetry")
