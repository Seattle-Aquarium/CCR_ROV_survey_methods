...
#: The program's tabs. They are the navigation now that there is no chapter
#: rail, so a step larger than the section strip they replace.
FONT_TAB = (FAMILY_MEDIUM, 15)
FONT_TAB_ON = (FAMILY_SEMIBOLD, 15)
